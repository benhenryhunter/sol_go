...
func (_Main *MainCaller) TokenByIndex(opts *bind.CallOpts, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Main.contract.Call(opts, &out, "tokenByIndex", index)
...
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Main *MainSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Main.Contract.TokenByIndex(&_Main.CallOpts, index)
}

// TokenByIndex is a free data retrieval call binding the contract method 0x4f6ccce7.
//
// Solidity: function tokenByIndex(uint256 index) view returns(uint256)
func (_Main *MainCallerSession) TokenByIndex(index *big.Int) (*big.Int, error) {
	return _Main.Contract.TokenByIndex(&_Main.CallOpts, index)
}
...
func (_Main *MainCaller) TokenOfOwnerByIndex(opts *bind.CallOpts, owner common.Address, index *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Main.contract.Call(opts, &out, "tokenOfOwnerByIndex", owner, index)
...
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Main *MainSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Main.Contract.TokenOfOwnerByIndex(&_Main.CallOpts, owner, index)
}

// TokenOfOwnerByIndex is a free data retrieval call binding the contract method 0x2f745c59.
//
// Solidity: function tokenOfOwnerByIndex(address owner, uint256 index) view returns(uint256)
func (_Main *MainCallerSession) TokenOfOwnerByIndex(owner common.Address, index *big.Int) (*big.Int, error) {
	return _Main.Contract.TokenOfOwnerByIndex(&_Main.CallOpts, owner, index)
}
